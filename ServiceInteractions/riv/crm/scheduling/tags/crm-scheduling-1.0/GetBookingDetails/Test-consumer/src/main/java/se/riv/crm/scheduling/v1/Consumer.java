...
public final class Consumer {
	...
	public static void main(final String[] args) {
		...
		final String adress = "https://localhost:21000/vp/GetBookingDetails/1/rivtabp20";
	...
	public static String callService(final String serviceAddress, final String logicalAddresss) {
		...
		final GetBookingDetailsResponderInterface service = new GetBookingDetailsResponderService(
			Consumer.createEndpointUrlFromServiceAddress(serviceAddress)).getGetBookingDetailsResponderPort();

		final AttributedURIType logicalAddressHeader = new AttributedURIType();
		logicalAddressHeader.setValue(logicalAddresss);

		final GetBookingDetailsType request = new GetBookingDetailsType();
		 ...
		 */
		final GetBookingDetailsResponseType result = service.getBookingDetails(logicalAddressHeader, request);
