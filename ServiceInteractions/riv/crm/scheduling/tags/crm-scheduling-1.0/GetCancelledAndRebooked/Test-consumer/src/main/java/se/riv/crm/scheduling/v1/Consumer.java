...
import se.riv.crm.scheduling.getcancelledandrebooked.v1.GetCancelledAndRebookedResponderService;
...
public final class Consumer {
	...
	public static void main(final String[] args) {
		...
		final String adress = "https://localhost:21000/vp/GetCancelledAndRebooked/1/rivtabp20";
	...
	public static String callService(final String serviceAddress, final String logicalAddresss) {
		...
		final GetCancelledAndRebookedresponderInterface service = new GetCancelledAndRebookedResponderService(
			Consumer.createEndpointUrlFromServiceAddress(serviceAddress)).getGetCancelledAndRebookedResponderPort();

		final AttributedURIType logicalAddressHeader = new AttributedURIType();
		logicalAddressHeader.setValue(logicalAddresss);

		final GetCancelledAndRebookedType request = new GetCancelledAndRebookedType();
		 ...
		 */
		final GetCancelledAndRebookedResponseType result = service.getCancelledAndRebooked(logicalAddressHeader, request);
