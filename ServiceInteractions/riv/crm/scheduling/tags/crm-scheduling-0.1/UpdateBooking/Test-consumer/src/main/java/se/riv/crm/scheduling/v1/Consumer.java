...
public final class Consumer {
	...
	public static void main(final String[] args) {
		...
		final String adress = "https://localhost:21000/vp/UpdateBooking/1/rivtabp20";
	...
	public static String callService(final String serviceAddress, final String logicalAddresss) {
		...
		final UpdateBookingResponderInterface service = new UpdateBookingResponderService(
			Consumer.createEndpointUrlFromServiceAddress(serviceAddress)).getUpdateBookingResponderPort();

		final AttributedURIType logicalAddressHeader = new AttributedURIType();
		logicalAddressHeader.setValue(logicalAddresss);

		final UpdateBookingType request = new UpdateBookingType();
		 ...
		 */
		final UpdateBookingResponseType result = service.updateBooking(logicalAddressHeader, request);
