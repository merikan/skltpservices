...
public final class Consumer {
	...
	public static void main(final String[] args) {
		...
		final String adress = "https://localhost:21000/vp/CancelBooking/1/rivtabp20";
	...
	public static String callService(final String serviceAddress, final String logicalAddresss) {
		...
		final CancelBookingResponderInterface service = new CancelBookingResponderService(
			Consumer.createEndpointUrlFromServiceAddress(serviceAddress)).getCancelBookingResponderPort();

		final AttributedURIType logicalAddressHeader = new AttributedURIType();
		logicalAddressHeader.setValue(logicalAddresss);

		final CancelBookingType request = new CancelBookingType();
		 ...
		 */
		final CancelBookingResponseType result = service.cancelBooking(logicalAddressHeader, request);
