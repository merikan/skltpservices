...
public final class Consumer {
	...
	public static void main(final String[] args) {
		...
		final String adress = "https://localhost:21000/vp/GetAvailableDates/1/rivtabp20";
	...
	public static String callService(final String serviceAddress, final String logicalAddresss) {
		...
		final GetAvailableDatesResponderInterface service = new GetAvailableDatesResponderService(
			Consumer.createEndpointUrlFromServiceAddress(serviceAddress)).getGetAvailableDatesResponderPort();

		final AttributedURIType logicalAddressHeader = new AttributedURIType();
		logicalAddressHeader.setValue(logicalAddresss);

		final GetAvailableDatesType request = new GetAvailableDatesType();
		 ...
		 */
		final GetAvailableDatesResponseType result = service.getAvailableDates(logicalAddressHeader, request);
