...
public final class Consumer {
	...
	public static void main(final String[] args) {
		...
		final String adress = "https://localhost:21000/vp/GetSubjectOfCareSchedule/1/rivtabp20";
	...
	public static String callService(final String serviceAddress, final String logicalAddresss) {
		...
		final GetSubjectOfCareScheduleResponderInterface service = new GetSubjectOfCareScheduleResponderService(
			Consumer.createEndpointUrlFromServiceAddress(serviceAddress)).getGetSubjectOfCareScheduleResponderPort();

		final AttributedURIType logicalAddressHeader = new AttributedURIType();
		logicalAddressHeader.setValue(logicalAddresss);

		final GetSubjectOfCareScheduleType request = new GetSubjectOfCareScheduleType();
		 ...
		 */
		final GetSubjectOfCareScheduleResponseType result = service.getSubjectOfCareSchedule(logicalAddressHeader, request);
