...
import se.riv.clinicalprocess.healthcond.actoutcome.getmaternitymedicalhistory.v2.rivtabp21.GetMaternityMedicalHistoryResponderService;
...
public final class TestConsumer {
	...
	private static final String LOGISK_ADDRESS = "/GetMaternityMedicalHistory/2/rivtabp21";
	...
	public static String callService2(final String serviceAddress, final String logicalAddresss) {
		...
		try {
			...
			URL wsdlUrl = loader
					.getResource("schemas/interactions/GetMaternityMedicalHistoryInteraction/GetMaternityMedicalHistoryInteraction_2.0_RIVTABP21.wsdl");

			GetMaternityMedicalHistoryResponderService service = new GetMaternityMedicalHistoryResponderService(wsdlUrl);
			GetMaternityMedicalHistoryResponderInterface serviceInterface = service.getGetMaternityMedicalHistoryResponderPort();
			...
			GetMaternityMedicalHistoryResponseType response = serviceInterface.getMaternityMedicalHistory(LOGICAL_ADDRESS, request);

			return ("GetMaternityMedicalHistory response=" + response.getMaternityMedicalRecord());
