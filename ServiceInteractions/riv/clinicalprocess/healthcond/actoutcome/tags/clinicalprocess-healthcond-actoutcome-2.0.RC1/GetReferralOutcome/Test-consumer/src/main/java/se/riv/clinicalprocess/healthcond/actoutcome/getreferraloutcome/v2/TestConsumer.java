...
import se.riv.clinicalprocess.healthcond.actoutcome.getreferraloutcome.v2.rivtabp21.GetReferralOutcomeResponderService;
...
public final class TestConsumer {
	...
	private static final String LOGISK_ADDRESS = "/GetReferralOutcome/2/rivtabp21";
	...
	public static String callService2(final String serviceAddress, final String logicalAddresss) {
		...
		try {
			...
			URL wsdlUrl = loader
					.getResource("schemas/interactions/GetReferralOutcomeInteraction/GetReferralOutcomeInteraction_2.0_RIVTABP21.wsdl");

			GetReferralOutcomeResponderService service = new GetReferralOutcomeResponderService(wsdlUrl);
			GetReferralOutcomeResponderInterface serviceInterface = service.getGetReferralOutcomeResponderPort();
			...
			GetReferralOutcomeResponseType response = serviceInterface.getReferralOutcome(LOGICAL_ADDRESS, request);

			return ("GetCareDocumentation response=" + response.getReferralOutcome());
