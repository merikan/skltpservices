...
import se.riv.clinicalprocess.activityprescription.actoutcome.getvaccinationhistory.v1.rivtabp21.GetVaccinationHistoryResponderService;
...
public final class TestConsumer {
	...
	private static final String LOGISK_ADDRESS = "/GetVaccinationHistory/1/rivtabp21";
	...
	public static String callService2(final String serviceAddress, final String logicalAddresss) {
		...
		try {
			...
			URL wsdlUrl = loader
					.getResource("schemas/interactions/GetVaccinationHistoryInteraction/GetVaccinationHistoryInteraction_2.0_RIVTABP21.wsdl");

            GetVaccinationHistoryResponderService service = new GetVaccinationHistoryResponderService(wsdlUrl);
            GetVaccinationHistoryResponderInterface serviceInterface = service
					.getGetVaccinationHistoryResponderPort();
            ...
            GetVaccinationHistoryResponseType response = serviceInterface.getVaccinationHistory(LOGICAL_ADDRESS, request);

			return ("GetVaccinationHistory response=" + response.getVaccinationMedicalRecord());
