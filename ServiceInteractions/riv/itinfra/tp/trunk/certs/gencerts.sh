#!/bin/sh
#
# Generate certificates for the SKL TP v 1.0 Reference Sample
#
...
# We echo 1346 to start the certificate serial number counter.
...
# Have the CN=TheCA issue a certificate for CN=TP(localhost), Consumers and Producers via
