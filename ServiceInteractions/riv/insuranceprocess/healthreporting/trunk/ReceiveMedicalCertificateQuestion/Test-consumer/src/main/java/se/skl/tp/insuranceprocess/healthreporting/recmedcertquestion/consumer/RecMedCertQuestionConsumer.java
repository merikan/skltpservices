 ...
 */
package se.skl.tp.insuranceprocess.healthreporting.recmedcertquestion.consumer;
...
public final class RecMedCertQuestionConsumer {
	...
	private static final String LOGISK_ADDRESS = "/ReceiveMedicalCertificateQuestion/1/rivtabp20";
	...
	public static void main(String[] args) {
		...
		String p = callReceiveMedicalCertificateQuestion("RIV TA BP2.0 Ref App OK", adress, "FKTransform");
		System.out.println("Returned: " + p);
	}

	public static String callReceiveMedicalCertificateQuestion(String id, String serviceAddress,
		...
		try {
			...
			ReceiveMedicalCertificateQuestionResponseType result = service.receiveMedicalCertificateQuestion(
