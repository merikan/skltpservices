 ...
 *
 * This library is free software; you can redistribute it and/or modify it under the terms of version 2.1 of the GNU Lesser General Public
 *
...
public class MockServiceStandalone {

    protected MockServiceStandalone() throws Exception {
        ...
        Object implementor = new MockServiceImpl();
