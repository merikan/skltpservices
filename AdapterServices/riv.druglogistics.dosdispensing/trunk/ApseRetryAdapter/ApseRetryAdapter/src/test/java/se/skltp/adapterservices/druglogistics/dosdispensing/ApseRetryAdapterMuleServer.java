...
public class ApseRetryAdapterMuleServer {


	public static final String MULE_SERVER_ID   = "ApseRetryAdapter";
 

	private static final Logger logger = LoggerFactory.getLogger(ApseRetryAdapterMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/ApseRetryAdapter-common.xml"
        //
