...
public class MonitorLogTransformer extends AbstractMessageTransformer implements MuleContextAware {
	...
	public Object transformMessage(MuleMessage message, String outputEncoding) throws TransformerException {
		...
		try {
			...
			String httpQS = message.getInboundProperty("http.query.string");
			...
			if (message.getProperty(VPUtil.SERVICE_NAMESPACE, PropertyScope.SESSION) == null) {
				message.setProperty(VPUtil.SERVICE_NAMESPACE,
						"urn:riv:itintegration:monitoring:PingForConfiguration:1:rivtabp21", PropertyScope.SESSION);
			...
			case WARNING:
				...
				// message, integrationScenario, contractId,
				// null, extraInfo);
